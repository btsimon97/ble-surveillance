...
api_username = 'kismet'
api_password = 'kismet'
device_api_args = 'json={"fields": ["btle.device","kismet.device.base.commonname","kismet.device.base.first_time",' \
                  '"kismet.device.base.last_time","kismet.device.base.mod_time"]}'
device_api_url = "http://" + kismet_host + "/" + kismet_api_path + "-" + str(device_last_activity_timeout) \
                 + "/devices.json"
